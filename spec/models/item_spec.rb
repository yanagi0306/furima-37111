    ...
    context '出品できない' do
      ...
      context 'shipping_bearer_id関係' do
        ...
        it 'shipping_bearer_idが1' do
          ...
          expect(@item.errors.full_messages).to include("Shipping bearer can't be blank", "Shipping bearer Please make it a positive number from 2 to 3")
        end
        ...
        it 'shipping_bearer_id少数' do
          ...
          expect(@item.errors.full_messages).to include("Shipping bearer Please make it a positive number from 2 to 3")
        end
      ...
      context 'status_id関係' do
        ...
        it 'status_id数字以外' do
          ...
          expect(@item.errors.full_messages).to include("Status can't be blank", "Status Please make it a positive number from 2 to 7")
        end
        it 'status_id少数' do
          @item.status_id =  3.5
          @item.valid?

          expect(@item.errors.full_messages).to include("Status Please make it a positive number from 2 to 7")
        end
        it 'status_id負数' do
          @item.status_id = -2
          @item.valid?
      ...
      context 'shipping_day_id関係' do
        ...
        it 'shipping_day_id数字以外' do
          ...
          expect(@item.errors.full_messages).to include("Shipping day can't be blank", "Shipping day Please make it a positive number from 2 to 4")
        end
        it 'shipping_day_id少数' do
          @item.shipping_day_id = 2.5
          @item.valid?

          expect(@item.errors.full_messages).to include("Shipping day Please make it a positive number from 2 to 4")
        end
      ...
      context 'price関係' do
        ...
        it 'price数字以外' do
          ...
          expect(@item.errors.full_messages).to include("Price Please make it a positive number from 300 to 9999999")
        end
        it 'price少数' do
          @item.price = 2.5
          @item.valid?
      ...
      context 'prefecture_id関係' do
        ...
        it 'prefecture_id数字以外' do
          ...
          expect(@item.errors.full_messages).to include("Prefecture Please make it a positive number from 2 to 48")
        end
      ...
      context 'category_name_id関係' do
        it 'category_name_idが空' do
          ...
          expect(@item.errors.full_messages).to include("Category name can't be blank", "Category name can't be blank")
        end
        it 'category_name_id数字以外' do
          @item.category_name_id = 'aa'
          @item.valid?
          expect(@item.errors.full_messages).to include("Category name Please make it a positive number from 2 to 11")
        end
